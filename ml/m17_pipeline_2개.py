...
from sklearn.decomposition import PCA    # 차원(열, 특성, 컬럼...) 축소
...
model = make_pipeline(MinMaxScaler(), StandardScaler(), RandomForestClassifier())     # 알아서 합쳐진다 (스케일러 필요 x) // 스케일러 기준 (?) // 스케일러 2개 이상 쓸수 있다
                        # PCA()
#.3 컴파일, 훈련
