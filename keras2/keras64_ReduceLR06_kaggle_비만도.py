...
#2
model = Sequential()
model.add(Dense(17, input_shape = (16,)))
...
model.fit(x_train, y_train, epochs=200, batch_size=500, verbose=1, callbacks=[rlr])
#4
...
# lr : 1.0, ACC : 0.19484585741811175, loss : 1.9500641822814941

'''rlr 적용
lr : 1.0, ACC : 0.19484585741811175, loss : 1.9307540655136108
lr : 0.1, ACC : 0.4725433526011561, loss : 1.342450499534607
lr : 0.01, ACC : 0.660645472061657, loss : 0.7630707621574402
lr : 0.001, ACC : 0.7601156069364162, loss : 0.631173849105835
lr : 0.0001, ACC : 0.7015895953757225, loss : 0.7926943302154541
'''