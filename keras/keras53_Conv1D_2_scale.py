...
from keras.layers import Dense, SimpleRNN, LSTM, Dropout, Conv1D, Flatten
...
#2. 모델구성
model = Sequential()
# model.add(LSTM(100, input_shape = (3, 1)))  #  units(아웃풋 갯수), (timesteps, features)
...
# (1, 3, 1)
# 1/1 [==============================] - 0s 208ms/step
# [50,60,70,]의  결과 :  [[79.49326]]

# loss :  2.5710716108212628e-12
# (1, 3, 1)
# 1/1 [==============================] - 0s 55ms/step
# [50,60,70,]의  결과 :  [[80.]]
