...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(7, 2, padding='same', input_shape = (12,1)))
...
로스 :  0.3746739625930786
acc :  0.876798689365387
f1 :  0.8174897785928206
걸린시간 :  287.94 초

Conv1D
로스 :  0.42981329560279846
acc :  0.8452751636505127
f1 :  0.7926651390886948
걸린시간 :  113.13 초
