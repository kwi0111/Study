...
# model = Sequential()
# model.add(Conv2D(filters=100, kernel_size=(2, 2), padding='same', strides=1,  activation='swish', 
#                  input_shape=(28, 28, 1)))
...
model.fit(x_train, y_train, epochs=300, batch_size=500, verbose=1, callbacks=[es])
