...
#2. 모델
model = Sequential()
model.add(Dense(500, input_shape = (5,), activation='relu'))
...
model.fit(pad_x, y, epochs=500, batch_size=1, verbose=2)

#4. 평가 및 예측
results = model.evaluate(pad_x, y)
y_predict = model.predict(pad_x)
print("loss : ", results[0])
print("acc : ", results[1])

# print(y_predict)
loss :  0.34819528460502625
