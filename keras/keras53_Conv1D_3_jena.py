...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, train_size=0.85, random_state=2024, shuffle=True 
)
...
model.add(Conv1D(7, 20, input_shape = (720, 14)))
model.add(Flatten())
...
model.fit(x_train, y_train, epochs=1000, batch_size=128, verbose=1, callbacks=[es], validation_split=0.18)
...
# loss :  11.543342590332031
# (125907,) (125907, 1)
# R2 :  0.8360264831887043
