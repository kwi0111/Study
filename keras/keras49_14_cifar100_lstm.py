...
from keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, Dropout, Input,LSTM
...
x_train = x_train.reshape(-1, 192, 16)
x_test = x_test.reshape(-1, 192, 16)
...
#2. 모델 구성
model = Sequential()
model.add(LSTM(100, return_sequences=True, input_shape = (192,16))) 
model.add(LSTM(30))    
model.add(Dense(100))
model.add(Dense(10))
model.add(Dense(100))
...
LSTM
loss :  3.2750961780548096
acc :  0.2094999998807907
'''