...
augumet_size = 30000      # 가상 이미지의 수 (변수)

randidx = np.random.randint(x_train.shape[0], size=augumet_size)    # 50000중에서 30000개의 숫자를 뽑아내라.
                                                                    # np.random.randint(60000, 20000)
print(randidx)  # [27114 42506 48469 ... 36851 35174 23819]
print(np.min(randidx), np.max(randidx)) # 2 49996
