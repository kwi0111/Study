...
from keras.layers import Dense, Flatten, Conv2D, LSTM, Conv1D
...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(7, 2, padding='same', input_shape = (4,2)))
...
hist = model.fit(x_train, y_train, epochs=1000, batch_size=30, verbose=2,
...
# LSTM
# RMSE :  146.75206633296798
# r2 스코어 :  0.32086608492278723
# MSE :  21536.16796875

#Conv1D
# RMSE :  144.90769623234632
# r2 스코어 :  0.3378294324746889
# MSE :  20998.244140625
