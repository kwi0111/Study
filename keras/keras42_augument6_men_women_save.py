...
augumet_size = 300      # 가상 이미지의 수 (변수)

randidx = np.random.randint(x_train.shape[0], size=augumet_size)    # 중에서 8000개의 숫자를 뽑아내라.
...
# print(pd.value_counts(y_test))   # 0.0    3
# print(x_train.shape[0]) # 11309
...
# y = np.reshape(y, (-1,1)) 
# print(x_train.shape, y_train.shape) # (3309, 120, 120, 3) (3309, 1)
# print(x_test.shape, y_test.shape) # (1, 120, 120, 3) (1, 1)


np_path = 'c:/_data/_save_npy/'
np.save(np_path + 'keras42_5_x_train.npy', arr=x_train)    
np.save(np_path + 'keras42_5_y_train.npy', arr=y_train)   
np.save(np_path + 'keras42_5_x_test.npy', arr=x_test)    
np.save(np_path + 'keras42_5_y_test.npy', arr=y_test)    
