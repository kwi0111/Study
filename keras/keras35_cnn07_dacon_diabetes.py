...
x_train = x_train.reshape(-1, 7, 1, 1)
x_test = x_test.reshape(-1, 7, 1, 1)
test_csv = test_csv.reshape(-1, 7, 1, 1)
...
#2. 모델 구성
model = Sequential()
model.add(Conv2D(10, (1,1), input_shape = (7,1,1), activation='relu' ))
model.add(Flatten())
