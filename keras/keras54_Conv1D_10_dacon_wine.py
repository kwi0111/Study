...
test_csv = test_csv.reshape(-1, 6, 2)


#2. 모델 구성
model = Sequential()
model.add(Conv1D(7, 2, padding='same', input_shape = (6,2)))
...
# LSTM
# 로스 :  1.1465424299240112
# acc :  0.5127272605895996
# 걸린시간 :  31.67 초

#Conv1D
# 로스 :  1.5176793336868286
# acc :  0.3418181836605072
# 걸린시간 :  9.99 초
